...
public:
  set_alphabet(const std::set<symbol_type> & explicit_set_):explicit_set(explicit_set_) {
  ...
  bool contain(symbol_type s) const override { return explicit_set.count(s)!=0;}
